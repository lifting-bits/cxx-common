...
if(NOT PORT MATCHES "^((upb))$")
  set(VCPKG_CXX_FLAGS "-fsanitize=address -g -fno-eliminate-unused-debug-symbols -fno-omit-frame-pointer -fno-optimize-sibling-calls -ffunction-sections -fdata-sections")
  set(VCPKG_C_FLAGS "-fsanitize=address -g -fno-eliminate-unused-debug-symbols -fno-omit-frame-pointer -fno-optimize-sibling-calls -ffunction-sections -fdata-sections")
endif()
